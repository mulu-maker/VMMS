...
{
    /// <summary>
    /// ContentCarNext.xaml 的交互逻辑
    /// </summary>
    public partial class ContentCarNext : Window
    {
        public ObjCar s;

        public ContentCarNext()
        {
            InitializeComponent();
        }
        ...
        {
            dataGrid1.ItemsSource = DalCar.GetNextList(s);//查询符合条件的数据并刷新datagrid
